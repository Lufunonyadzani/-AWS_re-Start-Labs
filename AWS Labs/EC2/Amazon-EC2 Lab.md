...
2. The setup involves creating one instance using the Amazon Linux 2023 AMI 2023.9.2, with a t2.micro instance type, a new     security group for firewall settings, and an 8 GB storage volume. 
